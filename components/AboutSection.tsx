...
import { SiReact, SiHtml5, SiCss3, SiJavascript, SiSass, SiGit, SiNodedotjs, SiTailwindcss, SiNextdotjs, SiDocker, SiAmazonwebservices } from 'react-icons/si'
    ...
    <section id="about" className="py-24 bg-transparent">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center text-gray-300 text-lg leading-relaxed">
          <AnimatedElement>
            <p>
              Sou um desenvolvedor web, com conhecimentos em React.js, HTML5, CSS3, JavaScript, SASS, Git, GitHub e Node.js. Tenho paixão por criar interfaces modernas, funcionais e responsivas, sempre buscando unir boa experiência do usuário com código limpo e bem estruturado.
            </p>
          </AnimatedElement>
        </div>
