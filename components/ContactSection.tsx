          ...
          <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-6">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-cyan-500 text-black font-bold py-3 px-10 rounded-full hover:bg-cyan-400 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {status === 'success' && (
              <p className="text-center text-green-400">Mensagem enviada com sucesso! Responderei em breve.</p>
            )}
            {status === 'error' && (
              <p className="text-center text-red-400">Erro ao enviar. Tente novamente ou entre em contato pelo WhatsApp.</p>
            )}
          </form>
        </AnimatedElement>
      </div>
